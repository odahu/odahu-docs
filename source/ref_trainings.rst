...
Prerequisites:
    * The training data set locates in the `wine-training-data` bucket by `wine/11-11-2011/` directory.
    * The ML script expects that the data will locate in `data/` directory relative to the root git directory.
