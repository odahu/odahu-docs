...
# -*- coding: utf-8 -*-
#
# Odahu documentation build configuration file, created by
...
version = os.getenv('SHORT_VERSION', default = '1.0')
# The full version, including alpha/beta/rc tags.
release = os.getenv('FULL_VERSION', default = '1.0.0')
